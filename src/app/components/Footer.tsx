    ...
    <footer>
      ...
      <div className="webring-wrapper">
        <a
          ...
          rel="noopener noreferrer"
        >
          {/* inlined so the logo can't fail to load; iOS Safari would
              sometimes show a broken-image icon for the <img> version */}
          <svg
            viewBox="91 210 778 539.623"
            width={32}
            height={22}
            role="img"
        ...
        <div className="webring">
          <a className="webring-arrow" href={`https://se30webring.com?from=${SITE_URL}&dir=prev`}>
            ←
          </a>
          ...
          <a className="webring-arrow" href={`https://se30webring.com?from=${SITE_URL}&dir=next`}>
            →
          </a>
        </div>
      </div>
